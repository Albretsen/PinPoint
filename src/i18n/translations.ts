    ...
    groups: {
      ...
      create: {
        ...
        privacy: {
          ...
          publicInviteCodeDescription: 'This invite code can be shared with anyone to join your public group',
          privateInviteCodeDescription: 'Only people with this invite code can join your private group',
    ...
    groups: {
      ...
      create: {
        ...
        privacy: {
          ...
          publicInviteCodeDescription: 'Denne invitasjonskoden kan deles med alle for å bli med i denne offentlige gruppen',
          privateInviteCodeDescription: 'Bare personer med denne invitasjonskoden kan bli med i denne private gruppen',
